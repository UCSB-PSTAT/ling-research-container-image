            ...
            stages{
                ...
                stage('Test') {
                    steps {
                        ...
                        sh 'podman run -it --rm --pull=never localhost/$IMAGE_NAME R -e "library(\"bayestestR\");library(\"blockcluster\");library(\"ca\");library(\"CCA\");library(\"cowplot\");library(\"DirichletReg\");library(\"doParallel\");library(\"ellipse\");library(\"factoextra\");library(\"FactoMineR\");library(\"ggalluvial\");library(\"GGally\");library(\"ggbreak\");library(\"ggfittext\");library(\"ggforce\");library(\"ggmosaic\");library(\"ggpattern\");library(\"ggplot2\");library(\"ggrepel\");library(\"ggsunburst\");library(\"ggthemes\");library(\"ggVennDiagram\");library(\"ggwordcloud\");library(\"glossr\");library(\"keras\");library(\"lmerTest\");library(\"mclust\");library(\"ordinal\");library(\"plotly\");library(\"polr\");library(\"pvclust\");library(\"reticulate\");library(\"rezonateR\");library(\"rjson\");library(\"see\");library(\"spacyr\");library(\"vowels\")"'
